              ...
              <dialog id="my_modal_5" className="modal">
                <div className="kotak-modal">
                  ...
                  <div className="paragraf-modalmid">
                    <span>
                      Thank you for your reservation! We look forward to
                      welcoming you for an extraordinary culinary experience.
                      See you soon at our restaurant!
                    </span>
                  </div>
                  <div className="petunjuk-modalmid">
                    <span>
                      Press click the button below to close or back to home
                    </span>
                  </div>
                  <div className="box-yahtmbl">
                    ...
                    <form method="dialog" className="close-abgt">
                      <button
                        className="cls-butnnn"
                        onClick={() => pstop.fungsi(false)}
                      >
                        Close
                      </button>
                    </form>
